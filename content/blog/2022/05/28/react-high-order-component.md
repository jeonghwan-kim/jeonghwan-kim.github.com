...
Header가 돔에 붙으면 양식에 맞추어 로그를 남긴다.
...
함수 호출로 만드는 고차 컴포넌트는 이러한 코드를 만들기 쉽다.
...
- [예제 코드](https://github.com/jeonghwan-kim/jeonghwan-kim.github.io-examples/tree/main/2022-05-28-react-hoc)
