...
- 디지털 서명의 원리: 해쉬 함수 사용, 개인키로 서명, 평문과 서명 전달, 서명의 유효성 검증
- 디지털 서명 실습
...
- **해시 함수**로 평문을 요약할 수 있다.
- **암호화**로 평문을 암호화 및 복호화 할 수 있다.
- **비대칭키 암호화**로 더 안전게 암복호화 할 수 있다.
- 비 대칭키 암호화와 해시함수를 이용해 **디지털 서명**을 만들 수 있다.
- 디지털 서명을 이용한 **디지털 인증서**로 서버의 신원을 확인할 수 있다.
- 디지털 인증서를 이용해 보안 프로토콜인 **TLS**를 구현할 수 있다.
