...
- 0.2 네비게이션바: 메뉴목록, 주문내역 화면을 이동할 수 있다. (UI, 라우팅)
...
Navbarfmf Link로 교체해서 메뉴목록, 주문내역 화면 링크를 클릭하면 화면이 바뀌었다. 요구사항 0.2를 해결했다.

나머지 요구사항은 요청 주소에 따라 화면만 변경하는 수준이라서 하나도 하지 못했다.
