...
둘째, 컨택스트로부터 값을 제공받으려면 소비자를 사용해 렌더 프롭으로 children 인자를 사용한다. Routes는 라우터 컨택스트의 소비자를 사용했다. 공급자가 전달한 상태 값을 소비자의 children을 통해 렌더 프롭으로 전달 받은 것처럼.
